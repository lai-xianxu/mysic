<template>
  <div class="playlist-container">
    <div class="top-wrap">
      <div class="img-wrap">
        <img :src="songInfo.coverImgUrl + '?param=230y230'" alt="" />
      </div>
      <div class="info-wrap">
        ...
        <div class="author-wrap">
          <img
            class="avatar"
            :src="
              songInfo.creator && songInfo.creator.avatarUrl + '?param=35y35'
            "
            alt=""
          />
          <span class="name">{{
            songInfo.creator && songInfo.creator.nickname
          }}</span>
          <span class="time"
            >{{
              songInfo.creator && songInfo.createTime | dataFormat
            }}创建</span
          >
        </div>
        <div class="play-wrap">
        ...
        <div class="tag-wrap">
          ...
          <ul>
            <li v-for="(item, i) in songInfo.tags" :key="i">{{ item }}</li>
          </ul>
        </div>
        <div class="desc-wrap">
    ...
    <el-tabs v-model="activeIndex" @tab-click="tabClick">
      <el-tab-pane :label="`歌曲列表(${songList.length})`" name="1">
        <table class="el-table playlit-table">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <span v-for="(k, i) in item.ar" :key="i">
                  <span v-if="i < 4"
                    >{{ k.name }}
      ...
      <el-tab-pane :label="`评论(${playTotal + hotTotal})`" name="2">
        <!-- 精彩评论 -->
